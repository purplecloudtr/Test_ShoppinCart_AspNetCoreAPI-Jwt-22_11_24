...
namespace AspNetCoreAPI_Jwt_Bearer.Repositories
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        {
            await _context.Employees.AddAsync(employee);   //Ara katmana ekler.
            await _context.SaveChangesAsync();      //Veritabanına ekler.
            return employee;    //Sql'in verdiği id değeriyle birlikte döner.
        }
        ...
        {
            var orjEmployee = await _context.Employees.FirstOrDefaultAsync(e => e.Id == employee.Id);
